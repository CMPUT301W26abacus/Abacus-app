 ...
 *
 * Covers:
 *   US 01.02.01 — Create profile: name/email/phone input and validation
 *   US 01.02.02 — Update profile: field updates, save success/failure
 *   US 01.02.04 — Delete profile: soft-delete, field clearing, navigation signal
 *
 * Callback index reference:
 *   saveProfileAsync(Map, VoidCallback)  → callback at index 1 → callSaveCallback()
 *   deleteProfileAsync(VoidCallback)     → callback at index 0 → callDeleteCallback()
 *   getProfileAsync(UserCallback)        → callback at index 0 → callUserCallback()
 */
...
public class ProfileViewModelTest {
    ...
    @Test
    public void saveProfile_emailNoDot_setsEmailError() {
        vm.setName("Alice Smith");
    ...
    /** saveProfileAsync(Map, VoidCallback) — callback is at index 1. */
    ...
    /** deleteProfileAsync(VoidCallback) — callback is at index 0. */
    ...
    /** getProfileAsync(UserCallback) — callback is at index 0. */
