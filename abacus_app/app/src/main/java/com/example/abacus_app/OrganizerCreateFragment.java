 ...
 * Handles event details, registration dates, capacity, and posters.
 * 
 * @author Himesh
 * @version 1.0
 */
public class OrganizerCreateFragment extends Fragment {
    ...
    private void createEvent() {
        ...
        // In a real scenario, we would upload the image to Firebase Storage first 
        // and set the URL in the event object before saving to Firestore.
        // For the checkpoint, we save the event document.
        dataSource.createEvent(event).addOnSuccessListener(aVoid -> {
